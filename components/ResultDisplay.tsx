    ...
    return (
      <div className="brutal-card">
        <div className="brutal-card-header">
          ...
          <h2 className="brutal-card-title">ERROR</h2>
        </div>
        <div className="brutal-card-body">
          <div className="error-box">[ERROR] {error}</div>
          {onRetry && (
            <div style={{ marginTop: '20px' }}>
              <button onClick={onRetry} className="brutal-button brutal-button-secondary">
                RETRY
              </button>
            </div>
          )}
  ...
  return (
    <div className="brutal-card">
      <div className="brutal-card-header">
        ...
        <h2 className="brutal-card-title">AI RESPONSE</h2>
      </div>
      <div className="brutal-card-body">
